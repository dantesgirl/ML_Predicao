...
df = pd.read_csv('timsort_fogo_australia.csv')
...
print(f"\nCaracterisiticas selecionadas: {len(features)}")
...
plt.tight_layout()
plt.savefig('fire_prediction_random_forest.png', dpi=300, bbox_inches='tight')
print("\nVisualizations saved as 'fire_prediction_random_forest.png'")
